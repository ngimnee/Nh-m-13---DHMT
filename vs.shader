...
void main(void)
{
	...
	if (color == 9)    fragment_color = vec4(0.7, 0.7, 0.7, 0.0);//glass
	...
	if (color == 16)   fragment_color = vec4(0.45098039216, 0.98431372549, 0.99215686275, 0);//skyblue
	if (color == 17)    fragment_color = vec4(0.7, 0.7, 0.7, 1.0); //kính
	if (color == 18)	fragment_color = vec4(1.0, 0.4, 0.6, 1.0); //pink

	if (color == 19)   fragment_color = vec4(1.0, 0.85, 0.0, 1.0); //yellow
	if (color == 20)   fragment_color = vec4(0.1, 0.1, 0.6, 1.0); //lighter deep blue
